...
public class NXT {
    ...
    public byte[] setOutputState(Port port, byte speed, Mode mode, RegulationMode regulationMode, byte turnRatio, RunState runState, int tacholimit){
        ...
        if(/*nxtUsb.isConnected()*/true){
            ...
            //Port
            switch (port){
                case PORTA: outBytes[2] = (byte) 0x00;
                    break;
                case PORTB: outBytes[2] = (byte) 0x01;
                    break;
                case PORTC: outBytes[2] = (byte) 0x02;
                    break;
                case ALLOUTPUTPORTS:    outBytes[2] = (byte) 0xff;
                    break;
            }
            ...
            //Mode Byte
            switch (mode){
                case MOTORON: outBytes[4] = (byte) 0x01;
                    break;
                case MOTORON_BREAK: outBytes[4] = (byte) 0x03;
                    break;
                case MOTORON_REGULATED: outBytes[4] = (byte) 0x05;
                    break;
                case MOTORON_BREAK_REGULATED: outBytes[4] = (byte) 0x07;
                    break;

            }
            //RegulationMode
            switch (regulationMode){
                case IDLE:  outBytes[5] = (byte) 0x00;
                    break;
                case SPEED: outBytes[5] = (byte) 0x01;
                    break;
                case SYNC:  outBytes[5] = (byte) 0x02;
                    break;
            }
            //Turn Ratio
            ...
            //RunState
            switch (runState){
                case IDLE:  outBytes[7] = (byte) 0x00;
                    break;
                case RAMPUP:    outBytes[7] = (byte) 0x10;
                    break;
                case RUNNING:   outBytes[7] = (byte) 0x20;
                    break;
                case RAMPDOWN:  outBytes[7] = (byte) 0x40;
                    break;
            }
            //Tacholimit
    ...
    public byte[] setInputMode(Port port, SensorType sensorType, SensorMode sensorMode){
        ...
        if(nxtUsb.isConnected()){
            ...
            switch (port){
                case PORT1: outBytes[2] = (byte) (0x00);
                    break;
                case PORT2: outBytes[2] = (byte) (0x01);
                    break;
                case PORT3: outBytes[2] = (byte) (0x02);
                    break;
                case PORT4: outBytes[2] = (byte) (0x03);
                    break;
            }

            //SensorType
            switch (sensorType){
                case NO_SENSOR: outBytes[3] = (byte) (0x00);
                    break;
                case SWITCH:    outBytes[3] = (byte) (0x01);
                    break;
                case TEMPERATUR:    outBytes[3] = (byte) (0x02);
                    break;
                case REFELCTION:    outBytes[3] = (byte) (0x03);
                    break;
                case ANGLE:     outBytes[3] = (byte) (0x04);
                    break;
                case LIGHT_ACTIVE: outBytes[3] = (byte) (0x05);
                    break;
                case LIGHT_INACTIVE: outBytes[3] = (byte) (0x06);
                    break;
                case SOUND_DB: outBytes[3] = (byte) (0x07);
                    break;
                case SOUND_DBA: outBytes[3] = (byte) (0x08);
                    break;
                case CUSTOM: outBytes[3] = (byte) (0x09);
                    break;
                case LOWSPEED: outBytes[3] = (byte) (0x0A);
                    break;
                case LOWSPEED_9V: outBytes[3] = (byte) (0x0B);
                    break;
                case NO_OF_SENSOR_TYPES: outBytes[3] = (byte) (0x0C);
                    break;
            }

            switch (sensorMode){
                case RAWMODE: outBytes[4] = (byte) (0x00);
                    break;
                case BOOLEANMODE: outBytes[4] = (byte) (0x20);
                    break;
                case TRANSITIONCNTMODE: outBytes[4] = (byte) (0x40);
                    break;
                case PERIODECOUNTERMODE: outBytes[4] = (byte) (0x60);
                    break;
                case PCTFULLSCALEMODE: outBytes[4] = (byte) (0x80);
                    break;
                case CELSIUSMODE: outBytes[4] = (byte) (0xA0);
                    break;
                case FAHRENHEITMODE: outBytes[4] = (byte) (0xC0);
                    break;
                case ANGLESTEPMODE: outBytes[4] = (byte) (0xE0);
                    break;
                case SLOPEMASK: outBytes[4] = (byte) (0x1F);
                    break;
                case MODEMASK: outBytes[4] = (byte) (0xE0);
                    break;
            }
    ...
    public byte[] resetMotorPosition(Port port, boolean relativ){
        ...
        if(nxtUsb.isConnected()){
            ...
            if(relativ){outBytes[3] = (byte) 0X01;}
            else{outBytes[3] = (byte) 0X00;}
